...
leResult screenShow_Screen1(void)
{
    ...
    Screen1_PositionWidget->fn->setPosition(Screen1_PositionWidget, 173, 128);
    ...
    Screen1_ButtonWidget_RunLeft->fn->setSize(Screen1_ButtonWidget_RunLeft, 480, 148);
    ...
    Screen1_ButtonWidget_RunRight->fn->setSize(Screen1_ButtonWidget_RunRight, 480, 148);
