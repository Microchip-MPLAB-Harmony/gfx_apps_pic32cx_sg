...
leResult screenShow_ApplicationScreen(void)
{
    ...
    ApplicationScreen_Layer0_FillPanel->fn->setSize(ApplicationScreen_Layer0_FillPanel, 480, 320);
    ...
    ApplicationScreen_TitleLabel->fn->setPosition(ApplicationScreen_TitleLabel, 16, 48);
    ...
    ApplicationScreen_SloganButton->fn->setPosition(ApplicationScreen_SloganButton, -1, 270);
    ...
    ApplicationScreen_LogoButton->fn->setPosition(ApplicationScreen_LogoButton, 48, 110);
    ...
    ApplicationScreen_ImageTypeLabelWidget->fn->setPosition(ApplicationScreen_ImageTypeLabelWidget, 236, 148);
