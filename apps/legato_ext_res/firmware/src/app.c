...
// *****************************************************************************
// *****************************************************************************
static void  APP_WaitUntilTransferDone(void)
{
    //while(DRV_SST26_Status((SYS_MODULE_INDEX)DRV_SST26_INDEX) != SYS_STATUS_READY);
    while(DRV_SST26_TransferStatusGet((SYS_MODULE_INDEX)DRV_SST26_INDEX) == DRV_SST26_TRANSFER_BUSY);
}
                                        ...
                                        uint8_t* destBuffer)
{
    ...
    DRV_SST26_Read((SYS_MODULE_INDEX)DRV_SST26_INDEX , (uint32_t *)destBuffer, readSize, address);
    APP_WaitUntilTransferDone();   
    ...
    switch(appData.state)
    {
        ...
        case APP_STATE_INIT:
        {
            ...
            if(appData.deviceHandle != USB_DEVICE_HANDLE_INVALID)
            {
                ...
                //appData.state = APP_STATE_ERROR;//APP_STATE_QSPI_RESET;
        ...
        {
            //APP_ResetFlash();
            DRV_SST26_Open((SYS_MODULE_INDEX)DRV_SST26_INDEX , DRV_IO_INTENT_WRITE);
        ...
        case APP_STATE_QSPI_READ_JEDECID:
        {
            ...
            DRV_SST26_ReadJedecId((SYS_MODULE_INDEX)DRV_SST26_INDEX, (uint32_t *)qspiData.readBuffer);
        ...
        {
            //APP_ChipErase();
            DRV_SST26_ChipErase((SYS_MODULE_INDEX)DRV_SST26_INDEX);
        ...
        case APP_STATE_QSPI_WRITE:
        {
            ...
            DRV_SST26_PageWrite((SYS_MODULE_INDEX)DRV_SST26_INDEX, cdcReadAddress, sqiWriteAddress);
        ...
        {            
            ...
            DRV_SST26_Read((SYS_MODULE_INDEX)DRV_SST26_INDEX, sqiReadBuffAddress, PAGE_SIZE, sqiWriteAddress);
        ...
        case APP_STATE_QSPI_FINAL_WRITE:
        {
            ...
            if (numOfWriteBytes > 0)
            {
                ...
                DRV_SST26_PageWrite((SYS_MODULE_INDEX)DRV_SST26_INDEX, writeBufferAddress, 
                    (MEM_START_ADDRESS + appData.totalBytesWrite));
                appData.totalBytesWrite += PAGE_SIZE;
